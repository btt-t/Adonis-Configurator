...
module.kStandardFixedHeightFrameHeight = 28
...
module.kCheckboxWidth = 16
module.kCheckboxImageWidth = 16
...
function module.ShouldUseIconsForDarkerBackgrounds()
	local mainColor = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.MainBackground)
...
function module.syncGuiThemeChange(func)
	settings().Studio.ThemeChanged:Connect(function()
		func(settings().Studio.Theme:: StudioTheme)
	end)
	func(settings().Studio.Theme:: StudioTheme)
end
...
function module.syncGuiElementTitleColor(guiElement)
	local function setColors()
		guiElement.BackgroundColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.Titlebar)
	end
...
function module.syncGuiElementInputFieldColor(guiElement)
	local function setColors()
		guiElement.BackgroundColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.InputFieldBackground)
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
end
...
function module.syncGuiElementBackgroundColor(guiElement)
	local function setColors()
		guiElement.BackgroundColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.MainBackground)
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
end
...
function module.syncGuiElementStripeColor(guiElement)
	local function setColors()
		if ((guiElement.LayoutOrder + 1) % 2 == 0) then 
			...
			guiElement.BackgroundColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.CategoryItem)
		end
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
...
function module.syncGuiElementBorderColor(guiElement)
	local function setColors()
		guiElement.BorderColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.Border)
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
end
...
function module.syncGuiElementFontColor(guiElement)
	local function setColors()
		guiElement.TextColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.MainText)
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
end
...
function module.syncGuiElementScrollColor(guiElement)
	local function setColors()
		guiElement.ScrollBarImageColor3 = (settings().Studio.Theme:: StudioTheme):GetColor(Enum.StudioStyleGuideColor.ScrollBar)
	end
	settings().Studio.ThemeChanged:Connect(setColors)
	setColors()
end
...
function module.MakeFrame(name)
	...
	frame.BorderColor3 = Color3.fromRGB(223, 223, 223)

	module.syncGuiElementBackgroundColor(frame)
	module.syncGuiThemeChange(function(Theme: StudioTheme)
...
function module.MakeStandardFixedHeightFrame(name)
	return module.MakeFixedHeightFrame(name, module.kStandardFixedHeightFrameHeight)
end
...
function module.MakeStandardPropertyLabel(text, opt_ignoreThemeUpdates)
	...
	label.Position = UDim2.new(0, module.StandardLineLabelLeftMargin, 0.5, 0)--module.kTextVerticalFudge)
